...
const Prescription = () => {
  ...
  const handleViewPrescription = (prescriptionId, patientName) => {
    console.log('Xem đơn thuốc:', prescriptionId);
    alert(`Xem chi tiết đơn thuốc ${prescriptionId}\nBệnh nhân: ${patientName}\n\nChức năng này sẽ hiển thị thông tin chi tiết đơn thuốc.`);
  };

  const handlePrintPrescription = (prescriptionId) => {
    console.log('In đơn thuốc:', prescriptionId);
    alert(`In đơn thuốc ${prescriptionId}\n\nChức năng in sẽ được thêm sau.`);
  };

  // Fake prescription data - Khoa Sản
  const prescriptions = [
    {
      id: "TOA001",
      patientId: "BN001",
      ...
      date: "20/12/2025",
      diagnosis: "Thai 12 tuần - Bổ sung vitamin",
      itemCount: 3,
      status: "Đã kê",
    },
    {
    ...
    },
    {
      ...
      date: "22/12/2025",
      diagnosis: "Thai 35 tuần - ĐTĐ thai kỳ",
      itemCount: 2,
    ...
    },
    {
      ...
      date: "25/12/2025",
      diagnosis: "Sau sinh - Kháng sinh và giảm đau",
      itemCount: 3,
      status: "Đã kê",
    },
  ];
                ...
                <Td>
                  <HStack spacing={2}>
                    <Button 
                      size="sm" 
                      colorScheme="blue"
                      onClick={() => handleViewPrescription(prescription.id, prescription.patientName)}
                    >
                      Xem
                    </Button>
                    <IconButton
