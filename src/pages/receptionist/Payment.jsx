  ...
  const handleSearch = () => {
    if (searchTerm) {
      setSelectedBill({
        ...
        hasInsurance: true,
        items: [
          { name: "Phí khám bệnh", price: 150000, insurance: 120000 },
          { name: "Xét nghiệm máu", price: 200000, insurance: 160000 },
          { name: "Chụp X-quang", price: 300000, insurance: 240000 },
          { name: "Thuốc điều trị", price: 450000, insurance: 0 },
        ],
      });
